...
if (MKL_INCLUDE_DIRS AND MKL_LIBRARIES AND MKL_INTERFACE_LIBRARY AND
    MKL_SEQUENTIAL_LAYER_LIBRARY AND MKL_CORE_LIBRARY AND MKL_SCALAPACK_LIBRARY AND
    MKL_BLACS_LIBRARY)
...
if(NOT BUILD_SHARED_LIBS)
  if (WIN32)
    ...
    set(SCAL_LIB "mkl_scalapack_ilp64.lib")
    set(BLACS_LIB "mkl_blacs_openmpi_ilp64.lib")
  else()
    set(INT_LIB "libmkl_intel_lp64.a")
    set(SEQ_LIB "libmkl_sequential.a")
    set(THR_LIB "libmkl_intel_thread.a")
    set(COR_LIB "libmkl_core.a")
    set(SCAL_LIB "libmkl_scalapack_lp64.a")
    set(BLACS_LIB "libmkl_blacs_openmpi_lp64.a")
  endif()
else()
  ...
  set(SCAL_LIB "mkl_scalapack_lp64")
  set(BLACS_LIB "mkl_blacs_openmpi_lp64")
endif()
...
set(MKL_LIBRARIES ${MKL_INTERFACE_LIBRARY} ${MKL_SEQUENTIAL_LAYER_LIBRARY} ${MKL_CORE_LIBRARY} ${MKL_SCALAPACK_LIBRARY} ${MKL_BLACS_LIBRARY})
...
FIND_PACKAGE_HANDLE_STANDARD_ARGS(MKL DEFAULT_MSG MKL_LIBRARIES MKL_INCLUDE_DIRS MKL_INTERFACE_LIBRARY MKL_SEQUENTIAL_LAYER_LIBRARY MKL_CORE_LIBRARY MKL_SCALAPACK_LIBRARY MKL_BLACS_LIBRARY)

MARK_AS_ADVANCED(MKL_INCLUDE_DIRS MKL_LIBRARIES MKL_INTERFACE_LIBRARY MKL_SEQUENTIAL_LAYER_LIBRARY MKL_CORE_LIBRARY MKL_SCALAPACK_LIBRARY MKL_BLACS_LIBRARY)
