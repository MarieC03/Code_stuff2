...
d2=read.load(15,file='./cylind_dd2bns_50ms_230125_128x128lv5do400_prim_weno5',type='vtu')
d3=read.load(30,file='./cylind_dd2bns_50ms_230125_128x128lv5do400_prim_weno5',type='vtu')
d4=read.load(1000,file='./cylind_dd2bns_50ms_230125_128x128lv5do400_prim_weno5',type='vtu')
...
# t0 time slice
file =  np.loadtxt('./cylind_dd2bns_50ms_230125_128x128lv5do400_prim_weno5_d2_x+0.00D+00_n0000.csv', delimiter=',', skiprows=1)
file2 = np.loadtxt('./cylind_dd2bns_50ms_230125_128x128lv5do400_prim_weno5_d2_x+0.00D+00_n0000.csv', delimiter=',', skiprows=1)

# Next time slice
file4 = np.loadtxt('./cylind_dd2bns_50ms_230125_128x128lv5do400_prim_weno5_d2_x+0.00D+00_n0015.csv', delimiter=',', skiprows=1)
...
file5 = np.loadtxt('./cylind_dd2bns_50ms_230125_128x128lv5do400_prim_weno5_d2_x+0.00D+00_n0030.csv', delimiter=',', skiprows=1)
file6 = np.loadtxt('./cylind_dd2bns_50ms_230125_128x128lv5do400_prim_weno5_d2_x+0.00D+00_n1000.csv', delimiter=',', skiprows=1)
...
ax9.plot(r6,psi6, '.', markerfacecolor='none', markersize=5, color='orange',label='$\mathtt{BHAC}$ at $t= 1~\mathrm{s}$')
#ax9.plot(r,psi, color='black', linestyle='dashed')
ax9.legend(loc='upper right',prop={'size': 12})
...
plt.show()
#plt.savefig("../Figures/DD2BNS_from50+10ms_lv5_128do400_1dslices.pdf", bbox_inches="tight")
