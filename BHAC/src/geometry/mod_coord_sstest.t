...
!================================================================================
  ...
  !=============================================================================
  ! Metric components for Schwarzschild coordinates -coord=sstest
  !
  ! Testing numerical derivatives with accurate complex-step method
  ! See e.g. Joaquim R. R. A. Martins et al. doi>10.1145/838250.838251
  ! So the user does not need to provide analytic derivatives.
  ! 
  ! Oliver Porth
  ! 11.02.2015
  !=============================================================================
  ...
  character*20, parameter              :: coord="sstest"
...
!=============================================================================
  ...
  subroutine get_sqrtgamma_analytic(x^D,sqrtgamma,is_analytic)
    ...
    {^IFZIN
    sqrtgamma = (x1**2 * sin(x^Z) / sqrt(1.0d0 - 2.0d0*eqpar(m_)/x1))
    }{^IFZOUT
  ...
  contains
    ...
    double complex function grr(x^D)
      ...
      grr = 1.0d0/(1.0d0-2.0d0*eqpar(m_)/x1)
