...
!================================================================================
  ...
  character*20, parameter              :: coord="cartfunky"
  ...
  integer, parameter                   :: ncoordpar = 7
  double precision, save               :: coordpar(ncoordpar) 

  integer,parameter                    :: beta1_=1, beta2_=2, beta3_=3, &
       g11_=4, g22_=5, g33_=6, alpha_=7
...
!=============================================================================
  ...
  subroutine CoordToBL(ixI^L,ixO^L,xCoord,xBL)
    ...
    if (eqpar(m_) .gt. zero) &
         call mpistop("BLToCoord: Cannot transform from Cartesian for non-zero mass")
