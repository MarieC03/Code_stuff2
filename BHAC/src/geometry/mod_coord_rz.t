...
!================================================================================
  ...
  !
  ! There might be coordinate singularities as this is not yet handled in any way.  
  ! 
  ! Oliver Porth
  ! 19.02.2015
  ! Modified: Yosuke Mizuno
  ! 07.12.2016
  !=============================================================================
  ...
  character*20, parameter              :: coord="rz"
...
!=============================================================================
  ...
  subroutine get_sqrtgamma_analytic(x^D,sqrtgamma,is_analytic)
    ...
    {^IFZIN
    sqrtgamma = B(xcompact(cmplx(x1, 0.0d0, kind(1.d0)))) / sqrt(N2(xcompact(cmplx(x1, 0.0d0, kind(1.d0))))) * x1**2 * sin(x^Z)
    }{^IFZOUT
    sqrtgamma = B(xcompact(cmplx(x1, 0.0d0, kind(1.d0)))) / sqrt(N2(xcompact(cmplx(x1, 0.0d0, kind(1.d0))))) * x1**2
    }
  ...
  contains
    ...
    double complex function grr(x^D)
      ...
      grr = B(xcompact(x1))**2 / N2(xcompact(x1))
