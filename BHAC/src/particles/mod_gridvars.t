...
integer, save                          :: igrid_working, ipart_working

{#IFDEF PARTICLES_LORENTZ
integer,parameter                      :: ngridvars=2*^NC
integer,parameter                      :: npayload=2
integer,parameter                      :: {bp^C_=^C}
integer, parameter                     :: {ep^C_=bp^NC_+^C}
}
integer,parameter                      :: ngridvars=^NC+3
integer,parameter                      :: npayload=3
integer,parameter                      :: {vp^C_=^C}, rhop_=^NC+1, pressp_=rhop_+1, bb2p_=pressp_+1

{#IFDEF PARTICLES_GEODESIC
integer, parameter                     :: ngridvars=1
integer,parameter                      :: npayload=0
integer, parameter                     :: emiss_=1
}
