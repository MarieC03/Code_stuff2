...
module mod_indices
   ...
   !
   ! ngridshi:  maximum number of grid blocks in a processor
   ! nlevelshi: maximum number of levels in grid refinement
 
   ! To all: These also related not only to memory explosion in hawk, but also too slow output of vtu in Calea 
   ! When ngridshi = 40000
   !integer, parameter :: ngridshi  = 2000
   integer, parameter :: ngridshi  = 1024
   !integer, parameter :: ngridshi  = 128
   ! TEST 
   !!--------------------------------
   !! approx: ngridshi * ncores = nblocks in bhac !!
   !!--------------------------------
