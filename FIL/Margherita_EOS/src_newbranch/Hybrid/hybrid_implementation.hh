...
// ###################################################################################
template <typename cold_eos>
double EOS_Hybrid<cold_eos>::press_temp__eps_rho_yle_ymu(double &temp, double &eps,
...
template <typename cold_eos>
double EOS_Hybrid<cold_eos>::press__eps_rho_yle_ymu(double &eps, double &rho,
...
template <typename cold_eos>
double EOS_Hybrid<cold_eos>::press__temp_rho_yle_ymu(double &temp, double &rho,
                                                double &ye, double& ymu, error_type &error) {
  using namespace Margherita_constants;
...
template <typename cold_eos>
double EOS_Hybrid<cold_eos>::eps__temp_rho_yle_ymu(double &temp, double &rho,
                                              double &ye, double& ymu, error_type &error) {
  using namespace Margherita_constants;
...
template <typename cold_eos>
double EOS_Hybrid<cold_eos>::press_cold__rho_yle_ymu(double &rho, double &ye, double& ymu,
                                                error_type &error) {
  double eps_cold;
...
template <typename cold_eos>
double EOS_Hybrid<cold_eos>::eps_cold__rho_yle_ymu(double &rho, double &ye, double& ymu,
                                              error_type &error) {
  double eps_cold;
  auto press_cold = cold_eos::press_cold_eps_cold__rho(eps_cold, rho, error);
...
template <typename cold_eos>
double EOS_Hybrid<cold_eos>::temp_cold__rho_yle_ymu(double &rho, double &ye, double& ymu,
                                               error_type &error) {
  return 0.0;
}
///////////
...
template <typename cold_eos>
double EOS_Hybrid<cold_eos>::eps__press_temp_rho_yle_ymu(double &press, double &temp,
                                                    double &rho, double &ye, double& ymu,
                                                    error_type &error) {
  double eps_cold;
  auto press_cold = cold_eos::press_cold_eps_cold__rho(eps_cold, rho, error);
...
template <typename cold_eos>
std::array<double, 2> EOS_Hybrid<cold_eos>::eps_range__rho_yle_ymu(
...
template <typename cold_eos>
std::array<double, 2> EOS_Hybrid<cold_eos>::entropy_range__rho_yle_ymu(
    double &rho, double &ye, double& ymu, error_type &error) {
  double eps_cold;
  auto press_cold = cold_eos::press_cold_eps_cold__rho(eps_cold, rho, error);
...
template <typename cold_eos>
double EOS_Hybrid<cold_eos>::press_h_csnd2__eps_rho_yle_ymu(double &h, double &csnd2,
...
template <typename cold_eos>
double EOS_Hybrid<cold_eos>::press_h_csnd2__temp_rho_yle_ymu(double &h,
                                                        double &csnd2,
                                                        double &temp,
                                                        double &rho, double &ye, double& ymu,
                                                        error_type &error) {
...
template <typename cold_eos>
double EOS_Hybrid<cold_eos>::eps_h_csnd2__press_rho_yle_ymu(double &h, double &csnd2,
                                                       double &press,
                                                       double &rho, double &ye, double& ymu,
                                                       error_type &error) {
  double eps_cold;
...
template <typename cold_eos>
double EOS_Hybrid<cold_eos>::press_eps_csnd2__temp_rho_yle_ymu(double &eps,
                                                        double &csnd2,
                                                        double &temp,
                                                        double &rho, double &ye, double& ymu,
                                                        error_type &error) {
...
template <typename cold_eos>
double EOS_Hybrid<cold_eos>::press_h_csnd2_temp_entropy__eps_rho_yle_ymu(
...
template <typename cold_eos>
double EOS_Hybrid<cold_eos>::eps_csnd2_entropy__temp_rho_yle_ymu(
    double &csnd2, double &entropy, double &temp, double &rho, double &ye, double& ymu,
    error_type &error) {
  using namespace Margherita_constants;
...
template <typename cold_eos>
double EOS_Hybrid<cold_eos>::press_h_csnd2_temp_eps__entropy_rho_yle_ymu(
...
template <typename cold_eos>
double EOS_Hybrid<cold_eos>::eps_h_csnd2_temp_entropy__press_rho_yle_ymu(
...
template <typename cold_eos>
double EOS_Hybrid<cold_eos>::press_eps_yle_ymu__beta_eq__rho_temp(
    double &eps, double &ye, double& ymu, double &rho, double &temp, error_type &error) {
  ye = 0;
...
template <typename cold_eos>
std::array<double, 4> EOS_Hybrid<cold_eos>::h_bound__rho1_rho2_yle_ymu(
    double &rho1, double &rho2, double &ye, double& ymu, error_type &error) {
  /*
...
template <typename cold_eos>
double EOS_Hybrid<cold_eos>::c2p_ymu_atm = 0.0;
template <typename cold_eos>
...
template <typename cold_eos>
double EOS_Hybrid<cold_eos>::eos_ymumax = 0;
template <typename cold_eos>
double EOS_Hybrid<cold_eos>::eos_ymumin = 0;
template <typename cold_eos>
double EOS_Hybrid<cold_eos>::baryon_mass = 0;
