...
//                  "Hempel_DD2EOS_rho234_temp180_ye60_version_1.1_20120817.h5");
  std::string("/Users/carlomusolino/numrel/EOS_Tables/scollapse/BHB_lpEOS_rho234_temp180_ye60_version_1.02_20140422.h5");
  ...
  */
    ...
    res = Margherita_Con2Prim<C2P_TYPE, EOS_Tabulated>(CONS, PRIMSN, METRIC,
                                                 error_bits);
  }
  ////////
  // Stop timing
