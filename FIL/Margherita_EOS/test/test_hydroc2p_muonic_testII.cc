...
//                  "Hempel_DD2EOS_rho234_temp180_ye60_version_1.1_20120817.h5");
  ...
  std::ofstream myfile ("c2p_iteration_test2_fixedrhoT_3D_merged_branch_mhdtc2p.log");
        ...
        if (EOS_Leptonic::use_muonic_eos) {
           ...
           for (int i = 0; i < MAXIT; ++i) {
             ...
             error_bits_t error_bits;
            	...
            	//					 error_bits);
                Margherita_Con2Prim<C2P_Hydro, EOS_Leptonic>(CONS, PRIMSN, METRIC, error_bits);
           }
           ...
           */
             ...
             error_bits_t error_bits;
            	...
            	//					 error_bits);
                Margherita_Con2Prim<C2P_Hydro, EOS_Tabulated>(CONS, PRIMSN, METRIC, error_bits);
           }
