...
int main() {
  ...
  constexpr double entropy_min = 1.0e-10;
  ...
  */
  ...
  std::array<double, C2P_MHD_ENTROPY<EOS_Polytropic>::numprims> PRIMSN;
  ...
  std::array<double, C2P_MHD_ENTROPY<EOS_Polytropic>::numcons> CONS;
  ...
  for (int i = 0; i < MAXIT; ++i) {
    ...
    CONS = C2P_MHD_ENTROPY<EOS_Polytropic>::compute_conservatives(PRIMS, METRIC,
                                                                  Bvec);
  ...
  */
    ...
    residual =Margherita_Con2Prim<C2P_MHD_ENTROPY, EOS_Polytropic>(CONS, PRIMSN, METRIC,
                                                         error_bits);
