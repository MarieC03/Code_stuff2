...
#define EOS_LEPTONIC_EOS_READTABLE_SCOLLAPSE_HH
...
void EOS_Leptonic::readtable_scollapse(const char *nuceos_table_name,
...
//  DECLARE_CCTK_PARAMETERS
  ...
  CCTK_VInfo(CCTK_THORNSTRING, "Reading nuc_eos table file (scollapse) for 4D Leptonic EOS:");
  ...
  // Read alltables_temp
  READ_EOSTABLE_HDF5("logpress", EOS_Leptonic::EBARYON::PRESS);
  READ_EOSTABLE_HDF5("logenergy", EOS_Leptonic::EBARYON::EPS);
  READ_EOSTABLE_HDF5("entropy", EOS_Leptonic::EBARYON::S);
  //  READ_EOSTABLE_HDF5("munu", 3);
  READ_EOSTABLE_HDF5("cs2", EOS_Leptonic::EBARYON::CS2);
  //  READ_EOSTABLE_HDF5("dedt", 5);
  //  READ_EOSTABLE_HDF5("dpdrhoe", 6);
  //  READ_EOSTABLE_HDF5("dpderho", 7);
  // chemical potentials
  //  READ_EOSTABLE_HDF5("muhat", 8);
  READ_EOSTABLE_HDF5("mu_e", EOS_Leptonic::EBARYON::MUE);
  READ_EOSTABLE_HDF5("mu_p", EOS_Leptonic::EBARYON::MUP);
  READ_EOSTABLE_HDF5("mu_n", EOS_Leptonic::EBARYON::MUN);
  // compositions
  READ_EOSTABLE_HDF5("Xa", EOS_Leptonic::EBARYON::XA);
  READ_EOSTABLE_HDF5("Xh", EOS_Leptonic::EBARYON::XH);
  READ_EOSTABLE_HDF5("Xn", EOS_Leptonic::EBARYON::XN);
  READ_EOSTABLE_HDF5("Xp", EOS_Leptonic::EBARYON::XP);
  // average nucleus
  READ_EOSTABLE_HDF5("Abar", EOS_Leptonic::EBARYON::ABAR);
  READ_EOSTABLE_HDF5("Zbar", EOS_Leptonic::EBARYON::ZBAR);
  // Gamma
  ...
  if (presubtract_e_contri) {
    CCTK_ERROR("EOS_Leptonic, presubtract_e_contri not support scollapse EOS format");
  }
  ...
  if (eos_yemax != eos_ylemax) {
   ...
   CCTK_ERROR("EOS_Leptonic::eos_ylemax != EOS_Leptonic::eos_yemax in scollapse reader");

  }
  if (eos_yemin != eos_ylemin) {
   std::cout << "\n EOS_Leptonic::eos_yemin != EOS_Leptonic::eos_ylemin ="<< eos_ylemin <<" "<<EOS_Leptonic::eos_yemin<<"\n";
   CCTK_ERROR("EOS_Leptonic::eos_ylemin != EOS_Leptonic::eos_yemin in scollapse reader");
  }
