...
void EOS_Tabulated::readtable_compose(const char *nuceos_table_name) {
  ...
  if (add_ele_contribution) {
  	if (eos_yemax != eos_ylemax) {
  	 std::cout << "\n EOS_Tabulated::eos_yemax != EOS_Tabulated::eos_ylemax ="<< eos_ylemax <<" "<<EOS_Tabulated::eos_yemax<<"\n";
  	 CCTK_ERROR("EOS_Tabulated::eos_ylemax != EOS_Tabulated::eos_yemax in compose reader");

  	}
  	if (eos_yemin != eos_ylemin) {
  	 std::cout << "\n EOS_Tabulated::eos_yemin != EOS_Tabulated::eos_ylemin ="<< eos_ylemin <<" "<<EOS_Tabulated::eos_yemin<<"\n";
  	 CCTK_ERROR("EOS_Tabulated::eos_ylemin != EOS_Tabulated::eos_yemin in compose reader");
  	}
  }
  ...
  if(EOS_Tabulated::generate_cold_table_local){
   EOS_Tabulated::generate_cold_table(logrho, nrho);
  }
