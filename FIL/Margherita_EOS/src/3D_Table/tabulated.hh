...
class EOS_Tabulated {
 ...
 // should I delete this?
  ...
  static constexpr bool has_ymu = false ; 
 ...
 public:
  static inline int index_pmax(const int &irho, const int &iye, const int iymu=0);

  // General accessors
  static double press__eps_rho_yle_ymu(double &eps, double &rho, double &ye, double& ymu,
                                  error_type &error);
  static double press_temp__eps_rho_yle_ymu(double &temp, double &eps, double &rho,
					    double &ye, double& ymu, error_type &error);
  static double press__temp_rho_yle_ymu(double &temp, double &rho, double &ye, double& ymu,
                                   error_type &error);
  static double eps__temp_rho_yle_ymu(double &temp, double &rho, double &ye,double& ymu,
                                 error_type &error);
  static double press_cold__rho_yle_ymu(double &rho, double &ye, double& ymu, error_type &error);
  static double eps_cold__rho_yle_ymu(double &rho, double &ye, double& ymu, error_type &error);
  static double temp_cold__rho_yle_ymu(const double &rho, const double &ye, const double& ymu,
                                  error_type &error);

  static double eps__press_temp_rho_yle_ymu(const double &press, double &temp,
					    double &rho, double &ye, double& ymu,
					    error_type &error);

  static std::array<double, 2> eps_range__rho_yle_ymu(double &rho, double &ye, double& ymu, 
                                                 error_type &error);

  static std::array<double, 2> entropy_range__rho_yle_ymu(double &rho, double &ye, double& ymu,
                                                     error_type &error);
  ...
  static double press_eps_yle_ymu__beta_eq__rho_temp(double &eps, double &ye, double& ymu,
                                                double &rho, double &temp,
                                                error_type &error);

  static double press_eps_yle_ymu__nu_beta_eq__rho_temp(double &eps, double &ye, double& ymu,
							double &rho, double &temp, const double &mu_nu_e_bar, const double& mu_nu_mu_bar,  
							error_type &error);


  static double mue_mup_mun_Xa_Xh_Xn_Xp_Abar_Zbar__temp_rho_yle_ymu(
  ...
  static double ye_plus_minus_press_e_press_b__temp_rho_yle_ymu(
        double &yle_plus,
  ...
  */
  ...
  static void readtable_leptonic(const char *leptonic_table_name);
  ...
  static double eos_ylemin, eos_ylemax;
  static double eos_ymumin, eos_ymumax;
  ...
  static double c2p_press_min;

  static double c2p_ymu_atm;
  ...
  static bool use_muonic_eos; // always false here
  ...
  //static int nrho, ntemp, nye;

  static linear_interp_uniform_ND_t<double, 3, EOS_Tabulated::EV::NUM_VARS> alltables;
  static linear_interp_uniform_ND_t<double, 3, EOS_Tabulated::EELE::NUM_VARS_ELE> alltables_ele;
};
