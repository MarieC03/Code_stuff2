...
//  DECLARE_CCTK_PARAMETERS
  ...
  if (presubtract_e_contri) {
    CCTK_ERROR("EOS_Tabulated, presubtract_e_contri not support scollapse EOS format");
  }
  ...
  if (add_ele_contribution) {
  	if (eos_yemax != eos_ylemax) {
  	 ...
  	 CCTK_ERROR("EOS_Tabulated::eos_ylemax != EOS_Tabulated::eos_yemax in scollapse reader");

  	}
  	if (eos_yemin != eos_ylemin) {
  	 std::cout << "\n EOS_Tabulated::eos_yemin != EOS_Tabulated::eos_ylemin ="<< eos_ylemin <<" "<<EOS_Tabulated::eos_yemin<<"\n";
  	 CCTK_ERROR("EOS_Tabulated::eos_ylemin != EOS_Tabulated::eos_yemin in scollapse reader");
  	}
  }
