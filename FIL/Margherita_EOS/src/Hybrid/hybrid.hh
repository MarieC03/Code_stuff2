...
class EOS_Hybrid {
 ...
 public:
  ...
  static double temp_cold__rho_yle_ymu(
      double &rho, double &ye, double& ymu,
      error_type &error);  // This is ill-defined for polytropes

  static double eps__press_temp_rho_yle_ymu(double &press, double &temp, double &rho,
                                       double &ye, double& ymu, error_type &error);
  ...
  static std::array<double, 4> h_bound__rho1_rho2_yle_ymu(double &rho1, double &rho2,
