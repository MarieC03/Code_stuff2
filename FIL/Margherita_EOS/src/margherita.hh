...
#define HAVEGR 1
  constexpr double LENGTHGF = 6.77269222552442e-06; // cm to CU
  constexpr double TIMEGF = 2.03040204956746e05;    // s to CU 
  constexpr double RHOGF = 1.61887093132742e-18;    // g/cm^3 to CU 
  constexpr double PRESSGF = 1.80123683248503e-39;  // dyn / cm^2 to CU
  constexpr double EPSGF = 1.11265005605362e-21;    // 1 / cCGS^2 
  constexpr double ENERGYGF  = 5.59424238e-55; // erg to CU
  constexpr double MASSGF = 5.02765209e-34;    // g to CU
...
constexpr double hc_MeVcm      = 1.23984198e-10;
constexpr double dpi = 3.14159265358979;


constexpr double MEVGF = ENERGYGF * MeV_to_erg; // change mev to CU
