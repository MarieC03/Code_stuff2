...
#ifndef _HH_M1_CONSTANTS
#define _HH_M1_CONSTANTS

namespace M1_Constants {
constexpr const double MYTOL = 1e-04 ;
constexpr const unsigned long int MAX_ITER_SIMPLEX = 1000;
constexpr const double MY_ROOTFINDING_TOL = 1e-15 ;
constexpr const unsigned long int MAX_ITER_ROOTFINDING = 100;
