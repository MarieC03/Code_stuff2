...
namespace frankfurt_m1 {
  ...
  public:
    ...
    CCTK_REAL inline get_average_energy(const CCTK_REAL& N) {
      return W*(E-Fv)/N*gamma->sqrtdet*Gamma ;
    }

    CCTK_REAL inline get_J() {
      return J ;
    }
...
//Harry: how to change it for muonic dYMU with eas?
    void get_number_source(CCTK_REAL &N, CCTK_REAL const& dt, std::array<CCTK_REAL, NUM_EAS> const& eas, 
