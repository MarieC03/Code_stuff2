...
// HarryL does here 0, 1, 2 meaning 3 species? or  grid x,y,z
  ...
  for(int i=0;i<cctk_lsh[0];i++) for(int j=0; j<cctk_lsh[1];j++) for(int k=0;k<cctk_lsh[2];k++){
	...
	CCTK_REAL const F32 = 3.15143479496164;
        ...
        if (use_5_spec_m1) {
                ...
                Nnue_bar_star[index3d] = Nnue_bar[index3d] * sqrtgamma ;
                Enue_bar_star[index3d] = Enue_bar[index3d] * sqrtgamma ;
                Ft_nue_bar_x[index3d]  = Fnue_bar_x[index3d] * sqrtgamma ;
                Ft_nue_bar_y[index3d]  = Fnue_bar_y[index3d] * sqrtgamma ;
                Ft_nue_bar_z[index3d]  = Fnue_bar_z[index3d] * sqrtgamma ;
                temp_nue_bar[index3d]  = temp[index3d];
                eps_nue_bar[index3d]   = F32*temp[index3d];

                Nnumu_star[index3d] = Nnumu[index3d] * sqrtgamma ;
                Enumu_star[index3d] = Enumu[index3d] * sqrtgamma ;
                Ft_numu_x[index3d]  = Fnumu_x[index3d] * sqrtgamma ;
                Ft_numu_y[index3d]  = Fnumu_y[index3d] * sqrtgamma ;
                Ft_numu_z[index3d]  = Fnumu_z[index3d] * sqrtgamma ;
                temp_numu[index3d]  = temp[index3d];
                eps_numu[index3d]   = F32*temp[index3d];

                Nnumu_bar_star[index3d] = Nnumu_bar[index3d] * sqrtgamma ;
                Enumu_bar_star[index3d] = Enumu_bar[index3d] * sqrtgamma ;
                Ft_numu_bar_x[index3d]  = Fnumu_bar_x[index3d] * sqrtgamma ;
                Ft_numu_bar_y[index3d]  = Fnumu_bar_y[index3d] * sqrtgamma ;
                Ft_numu_bar_z[index3d]  = Fnumu_bar_z[index3d] * sqrtgamma ;
                temp_numu_bar[index3d]  = temp[index3d];
                eps_numu_bar[index3d]   = F32*temp[index3d];
                ...
                zeta_nue[index3d] = 0.; zeta_nue_bar[index3d] = 0.; zeta_nux[index3d] = 0.;
		zeta_numu[index3d] = 0.; zeta_numu_bar[index3d] = 0.;
		...
		eps_nux[index3d]   = F32*temp[index3d];
                ...
                // now is 3 spec, numu numubar zeros
                Nnumu_star[index3d] = 0.; 
                Enumu_star[index3d] = 0.; 
                Ft_numu_x[index3d]  = 0.;  
                Ft_numu_y[index3d]  = 0.;  
                Ft_numu_z[index3d]  = 0.;  
                temp_numu[index3d]  = 0.; 
                ...
                Nnumu_bar_star[index3d] = 0.;
                Enumu_bar_star[index3d] = 0.;
                Ft_numu_bar_x[index3d]  = 0.;
                Ft_numu_bar_y[index3d]  = 0.;
                Ft_numu_bar_z[index3d]  = 0.;
                temp_numu_bar[index3d]  = 0.;
